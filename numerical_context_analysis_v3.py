"""
Contextual Numerical Representation Analysis v3 (Llama-3.2-3B)
=============================================
Experiment C: the same context, but numbers with very different
clinical or physical meanings, using the 3B model.
...
print("=" * 70)
print("Contextual Numerical Representation Analysis v3 (Llama-3.2-3B)")
print("Experiment C: same context, numbers with different clinical meanings (3B model)")
print("=" * 70)
...
# ============================================================
print("\n[Step 2] Running Experiment C (3B model)...")
...
output_path = "results/exp_C/numerical_context_analysis_v3.png"
...
print("=" * 70)
print("Done! Output image: numerical_context_analysis_v3.png")
print("=" * 70)
